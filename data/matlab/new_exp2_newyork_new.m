...
axes(ha(1));
plot(x,y1_4,'co-',x,y1_2,'mx-',x,y1_1,'r*-')
...
plot(x,(y1_1 * aPM +y2_1 * aVM) / 1000,'co-',x,(y1_2 * aPM +y2_2 * aVM) / 1000,'mx-',x,(y1_4 * aPM + y2_4 * aVM) / 1000,'r*-')
legend('VNF-OP','HEU','GA'); legend boxoff  
xlabel('时间（天）');
ylabel('能耗成本(KW)');
...
axes(ha(3));
plot(x,y3_1 / 1.78,'co-',x,y3_2 / 1.78,'mx-',x,y3_4 / 1.78,'r*-')
legend('VNF-OP','HEU','GA');   legend boxoff
xlabel('时间（天）');
ylabel('传输成本');
